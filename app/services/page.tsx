  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
        ...
        <div className="container flex h-20 items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <div className="group relative">
              <Link href="/services" className="text-sm font-medium text-primary transition-colors py-2 border-b-2 border-primary">
                OUR SERVICES
              </Link>
      ...
      <main className="flex-1">
        ...
        <section id="consulting" className="w-full py-16 md:py-24 bg-card">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-primary">Comprehensive HR Consulting</h2>
        ...
        <section id="recruitment" className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-primary">Full-Cycle Recruitment & Talent Acquisition</h2>
              <p className="text-foreground">
              ...
              <p className="text-foreground">Our goal is to ensure that your team grows with people who are genuinely passionate about your mission and vision.</p>
            </div>
          </div>
        </section>

        <section id="policy" className="w-full py-16 md:py-24 bg-card">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-primary">HR Policy & Process Development</h2>
              <p className="text-foreground">
              ...
              <p className="text-foreground">Whether you’re starting from scratch or refining an existing structure, we’ll make sure your policies support your long-term success.</p>
            </div>
          </div>
        </section>

        <section id="hris" className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-primary">HRIS Implementation</h2>
              <p className="text-foreground">
              ...
              <p className="text-foreground">Our implementation services reduce the stress and technical friction of introducing new HR tech into your organization.</p>
            </div>
          </div>
        </section>

        <section id="culture" className="w-full py-16 md:py-24 bg-card">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-primary">People & Culture Consulting</h2>
              <p className="text-foreground">
              ...
              <p className="text-foreground">Grounded in Indigenous knowledge and values, our approach is inclusive, honest, and sustainable.</p>
            </div>
          </div>
        </section>

        <section id="employee-relations" className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-primary">Employee Relations & Workplace Investigations</h2>
              <p className="text-foreground">
              ...
              <p className="text-foreground">We create a safe and confidential space for resolution—ensuring that issues are addressed with care and accountability.</p>
            </div>
          </div>
        </section>

        <section id="training" className="w-full py-16 md:py-24 bg-card">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-primary">Training & Development Programs</h2>
              <p className="text-foreground">Investing in your people is the key to long-term success. We support leadership development and team growth with customized learning opportunities.</p>
              ...
              <p className="text-foreground">We’re committed to making learning approachable, relevant, and impactful.</p>
            </div>
          </div>
        </section>

        <section id="resume-support" className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-primary">Resume, Cover Letter & Networking Support</h2>
              <p className="text-foreground">A strong first impression can open the door to career-changing opportunities. Whether you're entering the workforce, transitioning industries, or aiming for the next level in your career, we offer personalized support to help you stand out—on paper and in person.</p>
              <p className="text-foreground">We work closely with individuals to develop professional tools that reflect their authentic voice and unique value:</p>
              <ul className="list-disc list-inside space-y-2 text-foreground">
              ...
              <p className="text-foreground">Our approach is empathetic, practical, and grounded in the belief that everyone deserves support in building their career with confidence and clarity.</p>
            </div>
          </div>
        </section>

        <section id="individual-support" className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-primary">Support for Individuals</h2>
              <p className="text-foreground">We recognize that HR isn’t just for organizations—individuals need support, too. Whether you’re entering the workforce, changing careers, or navigating a challenging job situation, we offer resume and cover letter assistance, mock interview coaching, and personalized HR advice.</p>
              <p className="text-foreground">Our goal is to provide empathetic, empowering support that helps individuals show up as their authentic selves and succeed.</p>
            </div>
          </div>
        </section>
        ...
        <section className="w-full py-16 md:py-24 bg-card">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4 text-center">
              <h2 className="text-3xl font-bold text-primary">Let’s Build Together</h2>
              <p className="text-foreground">Our services are designed to grow with you. Whether you're building a team, navigating change, or rethinking your workplace culture, Anastasia’s HR Consulting is here to support your journey with heart, skill, and experience.</p>
              <p className="text-foreground">
