    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      >
        <div className="container flex h-20 items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="/contact" className="text-sm font-medium text-primary transition-colors border-b-2 border-primary">
              CONTACT US
            </Link>
          </nav>
          <Button
      ...
      <main className="flex-1">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-foreground">info@yourdomain.com</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="rounded-full bg-background p-3 text-primary">
                      ...
                      <div>
                        ...
                        <p className="text-foreground">1-(778)-773-55213</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="rounded-full bg-background p-3 text-primary">
        ...
        <section className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              <h2 className="text-3xl font-bold text-primary">Book a Discovery Call</h2>
              <p className="text-lg text-foreground">
