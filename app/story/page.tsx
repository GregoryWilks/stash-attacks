  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      >
        <div className="container flex h-20 items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <div className="group relative">
              <Link href="/story" className="text-sm font-medium text-primary transition-colors py-2 border-b-2 border-primary">
                OUR STORY
              </Link>
      ...
      <main className="flex-1">
        ...
        <section id="who-we-are" className="w-full py-16 md:py-24 bg-card">
          <div className="container px-4 md:px-6">
        ...
        <section id="mission" className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              ...
              <p className="text-foreground">We don’t just “do HR”—we build people-first systems that make your workplace stronger, more resilient, and more human.</p>
            </div>
          </div>
        </section>
        ...
        <section id="approach" className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-4">
              ...
              <p className="text-foreground">We operate with a culturally informed lens and a commitment to undoing harmful systemic structures. With the flexibility to support remote, hybrid, and in-person teams, our approach meets you where you are—and grows with you.</p>
            </div>
          </div>
        </section>
      </main>
