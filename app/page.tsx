    ...
    <div className="flex flex-col min-h-screen bg-[#fcf8ed]">
            ...
            <div className="group relative">
              ...
              <div className="absolute left-0 top-full mt-2 w-60 rounded-md bg-white shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                <div className="p-4 space-y-2">
                  <Link href="/services#consulting" className="block text-sm text-[#605246] hover:text-[#569121] py-1">
                    On-Demand HR Consulting
                  </Link>
                  <Link href="/services#cultural" className="block text-sm text-[#605246] hover:text-[#569121] py-1">
                    Cultural Competency & Inclusion
                  </Link>
                  <Link href="/services#talent" className="block text-sm text-[#605246] hover:text-[#569121] py-1">
                    Talent Management & Leadership
                  </Link>
                  <Link href="/services#mediation" className="block text-sm text-[#605246] hover:text-[#569121] py-1">
                    Workplace Mediation & Conflict Resolution
                  </Link>
                  <Link href="/services#policy" className="block text-sm text-[#605246] hover:text-[#569121] py-1">
                    HR Policy & Documentation
                  </Link>
                  <Link href="/services#change" className="block text-sm text-[#605246] hover:text-[#569121] py-1">
                    Change Management
                  </Link>
                  <Link href="/services#regulatory" className="block text-sm text-[#605246] hover:text-[#569121] py-1">
                    Regulatory Guidance
                  </Link>
                </div>
              </div>
      ...
      <main className="flex-1">
        <section className="w-full py-16 md:py-24 bg-[#fcf8ed]">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              <h1 className="text-4xl md:text-5xl font-bold text-[#569121]">
                Designing Workplaces Where People Thrive
              </h1>
              <p className="text-lg text-[#605246] leading-relaxed">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-[#569121]">Who We Are</h2>
                <div className="space-y-4 text-[#605246]">
                  <p>
        ...
        <section className="w-full py-16 md:py-24 bg-[#fcf8ed]">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center space-y-8">
              <h2 className="text-3xl font-bold text-[#569121]">Our Mission</h2>
              <p className="text-lg text-[#605246] italic">
              ...
              <h2 className="text-3xl font-bold text-[#569121] pt-8">Our Values</h2>
              <div className="grid md:grid-cols-3 gap-8 pt-4">
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-[#f69358]">Respect</h3>
                  <p className="text-[#605246]">We honor every individual's story and contribution.</p>
                </div>
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-[#f69358]">Integrity</h3>
                  <p className="text-[#605246]">Transparency, honesty, and ethical action guide every decision.</p>
                </div>
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-[#f69358]">Inclusion</h3>
                  <p className="text-[#605246]">Our work actively advances diversity, equity, and reconciliation.</p>
                </div>
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-[#f69358]">Innovation</h3>
                  <p className="text-[#605246]">We bring creativity and curiosity to every challenge.</p>
                </div>
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-[#f69358]">Collaboration</h3>
                  <p className="text-[#605246]">Success is built together, through genuine partnership.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-16 md:py-24 bg-white">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#569121]">Our Services</h2>
            </div>
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="bg-[#fcf8ed] p-6 rounded-lg shadow-sm border border-[#bcb5aa]">
                <h3 className="text-xl font-bold text-[#569121] mb-3">On-Demand HR Consulting</h3>
              ...
              <div className="bg-[#fcf8ed] p-6 rounded-lg shadow-sm border border-[#bcb5aa]">
                <h3 className="text-xl font-bold text-[#569121] mb-3">Cultural Competency & Inclusion</h3>
                <p className="text-[#605246]">
              ...
              <div className="bg-[#fcf8ed] p-6 rounded-lg shadow-sm border border-[#bcb5aa]">
                <h3 className="text-xl font-bold text-[#569121] mb-3">Talent Management & Leadership</h3>
                <p className="text-[#605246]">
              ...
              <div className="bg-[#fcf8ed] p-6 rounded-lg shadow-sm border border-[#bcb5aa]">
                <h3 className="text-xl font-bold text-[#569121] mb-3">Workplace Mediation & Conflict Resolution</h3>
                <p className="text-[#605246]">
              ...
              <div className="bg-[#fcf8ed] p-6 rounded-lg shadow-sm border border-[#bcb5aa]">
                <h3 className="text-xl font-bold text-[#569121] mb-3">HR Policy & Documentation</h3>
                <p className="text-[#605246]">
              ...
              <div className="bg-[#fcf8ed] p-6 rounded-lg shadow-sm border border-[#bcb5aa]">
                <h3 className="text-xl font-bold text-[#569121] mb-3">Change Management</h3>
                <p className="text-[#605246]">
            ...
            <div className="mt-8 text-center">
              <Link href="/services">
                <Button className="bg-[#569121] hover:bg-[#4a7e1c] text-white">View All Services</Button>
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="w-full py-16 md:py-24 bg-[#fcf8ed]">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#569121]">Our Approach</h2>
              <p className="text-xl font-medium text-[#f69358] mt-2">Listen. Learn. Design. Deliver.</p>
            </div>
            <div className="max-w-3xl mx-auto">
              <p className="text-[#605246] text-lg text-center">
        ...
        <section className="w-full py-16 md:py-24 bg-white">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#569121]">Client Stories & Testimonials</h2>
            </div>
            <div className="grid gap-8 md:grid-cols-3">
              <div className="bg-[#fcf8ed] p-6 rounded-lg shadow-sm border border-[#bcb5aa]">
                <p className="text-[#605246] italic mb-4">
        ...
        <section className="w-full py-16 md:py-24 bg-[#fcf8ed]">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#569121]">Resource Center</h2>
            </div>
            <div className="grid gap-12 lg:grid-cols-2">
              <div>
                <h3 className="text-2xl font-bold text-[#569121] mb-6">Insights & Guides</h3>
                <p className="text-[#605246] mb-4">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-[#605246]">The Power of Culturally-Informed HR</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#f69358]"></div>
                    <span className="text-[#605246]">Building Better Teams: A Practical Guide for Leaders</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#f69358]"></div>
                    <span className="text-[#605246]">Navigating Change: HR Strategies for Growth and Resilience</span>
                  </li>
                </ul>
                <div className="mt-6">
                  <Link href="/articles" className="text-[#569121] font-medium hover:underline">
                    Read More
                  </Link>
                </div>
              </div>
              <div>
                <h3 className="text-2xl font-bold text-[#569121] mb-6">Learning & Workshops</h3>
                <p className="text-[#605246] mb-4">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#f69358]"></div>
                    <span className="text-[#605246]">Indigenous Perspectives in Modern HR</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#f69358]"></div>
                    <span className="text-[#605246]">Creating a Culture of Respect and Accountability</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#f69358]"></div>
                    <span className="text-[#605246]">Managing Conflict with Empathy and Effectiveness</span>
                  </li>
                </ul>
                <div className="mt-6">
                  <Link href="/contact" className="text-[#569121] font-medium hover:underline">
                    Request a Workshop
                  </Link>
                </div>
              </div>
        ...
        <section className="w-full py-16 md:py-24 bg-white">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              <h2 className="text-3xl font-bold text-[#569121]">Commitment to Reconciliation</h2>
              <p className="text-[#605246]">
        ...
        <section className="w-full py-16 md:py-24 bg-[#fcf8ed]">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              <h2 className="text-3xl font-bold text-[#569121]">Frequently Asked Questions</h2>
              <div className="space-y-6 text-left">
                <div>
                  <h3 className="text-xl font-bold text-[#f69358]">Do you work with small businesses or startups?</h3>
                  <p className="text-[#605246] mt-2">
              ...
              <div className="pt-8">
                <Link href="/contact">
                  <Button className="bg-[#569121] hover:bg-[#4a7e1c] text-white">Contact Us</Button>
                </Link>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-16 md:py-24 bg-[#569121] text-white">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <div>
                <Link href="/contact">
                  <Button className="bg-white text-[#569121] hover:bg-[#fcf8ed]">Book Now</Button>
                </Link>
              </div>
