        ...
        <section className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-6">
              <h1 className="text-4xl md:text-5xl font-bold text-primary text-center">Frequently Asked Questions</h1>
              <div className="space-y-4 text-foreground">
                ...
                <div>
                  ...
                  <p>Based in Nanaimo, BC, Canada, we support remote, hybrid, and in-person teams wherever you are.</p>
                </div>
                <div>
